...
require "uri"
puts "*********************"
uri=URI.parse("http://163.ca/dz163/forum.php?mod=post&action=reply&fid=90&tid=147978&extra=page%3D1&replysubmit=yes&infloat=yes&handlekey=fastpost&inajax=1")
http = Net::HTTP.new(uri.host, uri.port)
request = Net::HTTP::Post.new(uri.request_uri)

request.set_form_data({
  message:"Beauty Infinity 电话 (204)775-7929 (204) 2216165",
  posttime:  "1365229013",
  formhash:"880c79dd",
  subject: ""})
...
request['Content-Length']= "81"
request['Content-Type']= "application/x-www-form-urlencoded"
request['Host'] ="www.163.ca"
request['Origin'] ="http://www.163.ca"
request['Referer'] ="http://www.163.ca/dz163/forum.php?mod=viewthread&tid=147978&extra=&page=505"
...
request['Cookie'] = "D0Hz_2132_saltkey=757Tw5gD; D0Hz_2132_lastvisit=1365223153; D0Hz_2132_visitedfid=90; D0Hz_2132_forum_lastvisit=D_90_1365226826; D0Hz_2132_auth=fcd9broB4cEL0FestBDEN%2Bz44LQujkXn1FtUZwkl6dr7Py74ANfC3oVzhhmFAzusREmEdtSrU58KnK%2FXnhbctXGNwg; D0Hz_2132_sid=Jst3Fr; D0Hz_2132_ulastactivity=7afeAjr9IXFZJaZM0mDUMjOvtve6XSi8MHv3%2BZLADLpa%2FsAOE46y; D0Hz_2132_smile=1D1; D0Hz_2132_sendmail=1; D0Hz_2132_lastact=1365257821%09home.php%09spacecp"
